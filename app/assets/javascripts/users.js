$(function() {
  ...
  function add_member(user) {
    var add_member = '<li>' + '<div class="chat-group-user clearfix">' +
 ...
 function new_member(user_id, user_name) {
    var new_member = '<li>' + '<div class="chat-group-user clearfix js-chat-member" id="chat-group-user-8">' +
